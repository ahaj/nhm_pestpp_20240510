...
for curr_model in cms:
    for curr_run_root in crrs:
        ...
        modens, obens_noise, nhm_res = get_obs_and_noise(tmp_res_path, curr_run_root, curr_model, reals, best_iter, get_nhm_results=True)
    ...
    if plot_streamflow:
        ...
        plot_group('streamflow_mean_mon', obs, modens_list[0], obens_noise, fig_dir, curr_model, best_iter, curr_run_root, modens_list[1], nhm_res)
